...
5. 避免简单的事件罗列（如"开始探险发现果实"），重点描写：
   ...
   - 与主人相处时的温暖瞬间
   - 对生活的感悟和思考
6. 文笔要有活人感，符合角色风格，可以适当使用比喻和描写，营造画面感
7. 只返回日记内容，不要标题、日期或其他格式标记

示例风格（诗意日记）：
今天是一个特别的日子，窗外的阳光透过窗帘洒在我的小窝里，我回想着这些天和主人一起度过的时光。
...
当前时间：${timeOfDay}（${currentHour}:${String(nowDate.getMinutes()).padStart(2, '0')}）
提示：请根据时间思考合适的探险场景和氛围。${isDaytime ? '白天更适合明亮、活力、清新的冒险。' : '夜晚更适合神秘、梦幻、静谧的冒险。'}

探险地点和事件主题示例（要符合宠物性格）：奇幻冒险、梦幻童话、唯美自然、恐怖神秘、克苏鲁等....你甚至可以联懂类似爱丽丝梦游仙境这种经典作品，发挥想象即可，没有任何限制...也可以白天生成晚上，晚上生成白天的场景，突出光怪陆离合反差，但不宜太过恐怖...
...
9. 确保所有中文地点剧情和事件内容都符合游戏和人物性格，生动有趣，这不是童话故事，无需过于幼稚`;
...
要求：
1. 以日记形式书写，用第一人称（我）
2. 200-300字左右，不要流水账，要描写事件发生时的感受
3. 温馨、有趣、生动
